...
class BraintreePaymentExceptionTest extends TestCase
{
    public function testConstruct(): void
    {
        ...
        $exception = new BraintreePaymentException('this-is-message', e: $previous, transactionId: 'transaction-id');
        ...
        static::assertSame(['transactionId' => 'transaction-id'], $exception->getParameters());
    }
}
